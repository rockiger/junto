...
export function PageMenu({ canEdit, fileId, onPageWidthToggle, pageWidth }) {
    ...
    const items = [
        {
            key: 'page_width',
            name: isReduced ? 'Switch to full width' : 'Switch to reduced width',
            handler: onPageWidthToggle,
            icon: isReduced
